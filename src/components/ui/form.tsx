...
function FormDescription({ className, ...props }: React.ComponentProps<"p">) {
  ...
  return <p id={formDescriptionId} className={cn("text-caption text-muted-foreground", className)} {...props} />
}
...
function FormMessage({ className, children, ...props }: React.ComponentProps<"p">) {
  ...
  if (!body) return null
  return <p id={formMessageId} className={cn("text-caption font-medium text-destructive", className)} {...props}>{body}</p>
}
